...
package com.binfast.adpter.core.converter;
...
import com.binfast.adpter.core.converter.Converters.BigDecimalConverter;
import com.binfast.adpter.core.converter.Converters.BigIntegerConverter;
import com.binfast.adpter.core.converter.Converters.BooleanConverter;
import com.binfast.adpter.core.converter.Converters.ByteConverter;
import com.binfast.adpter.core.converter.Converters.ByteArrayConverter;
import com.binfast.adpter.core.converter.Converters.DateConverter;
import com.binfast.adpter.core.converter.Converters.DoubleConverter;
import com.binfast.adpter.core.converter.Converters.FloatConverter;
import com.binfast.adpter.core.converter.Converters.IntegerConverter;
import com.binfast.adpter.core.converter.Converters.LongConverter;
import com.binfast.adpter.core.converter.Converters.SqlDateConverter;
import com.binfast.adpter.core.converter.Converters.ShortConverter;
import com.binfast.adpter.core.converter.Converters.TimeConverter;
import com.binfast.adpter.core.converter.Converters.TimestampConverter;
import com.binfast.adpter.core.converter.Converters.LocalDateTimeConverter;
import com.binfast.adpter.core.converter.Converters.LocalDateConverter;
...
public class TypeConverter {
	...
	private BiFunction<Class<?>, String, Object> convertFunc = null;
	...
	public BiFunction<Class<?>, String, Object> getConvertFunc() {
		return convertFunc;
	}

	public void setConvertFunc(BiFunction<Class<?>, String, Object> convertFunc) {
	...
	public final Object convert(Class<?> type, String s) throws ParseException {
		if (convertFunc != null){
			return convertFunc.apply(type,s);
		}
		...
		throw ExceptionFactory.sysException(type.getName() + " can not be converted, please use other type of attributes in your model!");
