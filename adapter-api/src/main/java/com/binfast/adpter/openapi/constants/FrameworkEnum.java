...
public enum FrameworkEnum {
     ...
     * Apache Dubbo
     */
    DUBBO("dubbo", "com.binfast.adpter.openapi.template.RpcDocBuildTemplate"),

    /**
     * Spring Framework
     */
    SPRING("spring", "com.binfast.adpter.openapi.template.SpringBootDocBuildTemplate"),

    /**
     * Solon
     */
    SOLON("solon", "com.binfast.adpter.openapi.template.SolonDocBuildTemplate"),

    /**
     * JAX-RS
     */
    JAX_RS("JAX-RS", "com.binfast.adpter.openapi.template.JaxrsDocBuildTemplate"),

    /**
     * Spring Adapter
     */
    SPRING_ADAPTER("spring-adapter", "com.binfast.adpter.openapi.template.SpringBootAdapterDocBuildTemplate");
