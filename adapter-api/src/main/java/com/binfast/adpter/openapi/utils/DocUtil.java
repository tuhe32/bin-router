...
import com.binfast.adpter.openapi.extension.dict.DictionaryValuesResolver;
...
import static com.binfast.adpter.openapi.constants.DocGlobalConstants.NO_COMMENTS_FOUND;
import static com.binfast.adpter.openapi.model.SystemPlaceholders.*;
...
public class DocUtil {
    ...
    public static Map<String, String> getCommentsByTag(final JavaMethod javaMethod, final String tagName, final String className) {
        ...
        for (DocletTag docletTag : paramTags) {
            ...
            if (DocTags.PARAM.equals(tagName)) {
                String pName = value;
                String pValue = NO_COMMENTS_FOUND;
    ...
    public static String getFirstKeyAndValue(Map<String, String> map) {
        ...
        if (map != null && map.size() > 0) {
            ...
            if (entry != null) {
                if (NO_COMMENTS_FOUND.equals(entry.getValue())) {
                    value = entry.getKey();
                } else {
